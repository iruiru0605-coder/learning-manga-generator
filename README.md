...
### ステップ4: DeepSeek の API キーを取得する（無料で始められます）
...
6. 学習漫画ジェネレーターの画面右上の「**APIキーを設定**」ボタンをクリックします

7. コピーしたキーを貼り付けて閉じます

🎉 **これで準備完了です！** あとは画面上の手順に従って教科書を選び、苦手を入力してください。

> 💡 DeepSeek は登録時に約500円分の無料クレジットがもらえます。学習漫画1回の生成は約0.5円なので、無料枠だけでも約1,000回使えます。
